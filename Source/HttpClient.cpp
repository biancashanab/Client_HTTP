...
std::string HttpClient::head(const std::string &host, const std::string &path, const std::map<std::string, std::string> &headers)
{
    return send_request("HEAD", host, path, headers);
}

std::string HttpClient::post(const std::string &host, const std::string &path, const std::map<std::string, std::string> &headers, const std::string &body)
{
    return send_request("POST", host, path, headers, body);
}

std::string HttpClient::put(const std::string &host, const std::string &path, const std::map<std::string, std::string> &headers, const std::string &body)
{
    return send_request("PUT", host, path, headers, body);
}

std::string HttpClient::del(const std::string &host, const std::string &path, const std::map<std::string, std::string> &headers)
{
    return send_request("DELETE", host, path, headers);
}

std::string HttpClient::connect(const std::string &host, const std::string &path, const std::map<std::string, std::string> &headers)
{
    return send_request("CONNECT", host, path, headers);
}

std::string HttpClient::trace(const std::string &host, const std::string &path, const std::map<std::string, std::string> &headers)
{
